...
Функция ЭтоСтрокаСоединенияСРабочейБазой()
	...
	Возврат мт_ТестированиеКонфигурации_Сервер.ЭтоСтрокаСоединенияСРабочейБазой(СтрокаСоединенияСБазойТестирования);
...
Процедура КомандаСоздатьСценарииТестирования(Команда)
	...
	#Если WebКлиент Тогда
		ПоказатьПредупреждение(, "В данном режиме данный функционал не работает", , );
		Возврат;
	#КонецЕсли
